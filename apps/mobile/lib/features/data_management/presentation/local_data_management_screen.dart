...
class _LocalDataManagementScreenState
        ...
        child: ListView(
          ...
          children: [
            ...
            _DataActionCard(
              ...
              destructive: true,
              enabled: !_busy && (statsValue?.snapshotCount ?? 0) > 0,
            ...
            _DataActionCard(
              ...
              destructive: false,
              enabled: !_busy && (statsValue?.ignoredCount ?? 0) > 0,
            ...
            _DataActionCard(
              ...
              destructive: true,
              emphasized: true,
              enabled: !_busy && !(statsValue?.isEmpty ?? true),
  ...
  Future<void> _runBusy(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Yerel veri işlemi tamamlanamadı. Lütfen tekrar dene.'),
        ),
      );
    } finally {
